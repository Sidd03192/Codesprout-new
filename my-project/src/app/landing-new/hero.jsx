  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 text-center max-w-[90%]">
        ...
        <div className="relative z-10 inline-flex items-center justify-center gap-4 group">
          <div className="absolute inset-0 duration-1000 opacity-60 transitiona-all cursor-crosshair bg-gradient-to-r from-indigo-500 via-pink-500 to-emerald-400 rounded-xl blur-md filter group-hover:opacity-100 group-hover:duration-200"></div>
          <a
            role="button"
