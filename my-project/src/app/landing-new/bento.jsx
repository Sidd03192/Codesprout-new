      ...
      <div className="container mx-auto px-6" ref={containerRef}>
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Built specifically for educators, by educators. See how we're
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
          {/* Main Feature Card */}
          <article
            className={`group card-glass rounded-2xl md:col-span-4 flex flex-col justify-between min-h-[280px] relative overflow-hidden transition-all duration-700 hover:scale-[1.02] hover:shadow-2xl transform ${
              containerInView
                ? "translate-y-0 opacity-100"
                : "translate-y-10 opacity-0"
            }`}
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Our intelligent teaching assistant provides instant hints and
                explanations, helping students learn programming concepts while
                you focus on what matters most - teaching.
              </p>
          ...
          {/* Time Saving Card */}
          <article
            className={`group card-glass rounded-2xl md:col-span-2 min-h-[280px] relative overflow-hidden hover:scale-[1.02] transition-all duration-700 transform ${
              containerInView
                ? "translate-y-0 opacity-100"
                : "translate-y-10 opacity-0"
            }`}
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Automated grading and instant feedback reduce manual work by up
                to 75%.
              </p>
          ...
          <article
            className={`group card-glass rounded-2xl md:col-span-2 min-h-[260px] relative overflow-hidden hover:scale-[1.02] transition-all duration-700 transform ${
              containerInView
                ? "translate-y-0 opacity-100"
                : "translate-y-10 opacity-0"
            }`}
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Standards-aligned curriculum with real-time progress tracking
          ...
          <article
            className={`group card-glass rounded-2xl md:col-span-4 min-h-[260px] bg-[linear-gradient(var(--gradient-brand))] text-[hsl(var(--brand-contrast))] relative overflow-hidden hover:scale-[1.02] transition-all duration-700 transform ${
              containerInView
                ? "translate-y-0 opacity-100"
                : "translate-y-10 opacity-0"
            }`}
          ...
          >
            ...
            <div className="absolute inset-0 opacity-10">
              ...
              <div
                className="absolute bottom-4 right-4 w-6 h-6 border border-white/30 rounded-full animate-ping"
                style={{ animationDelay: "1s" }}
              />
              <div
                className="absolute top-1/2 left-1/2 w-4 h-4 border border-white/30 rounded-full animate-ping"
            ...
            <div className="relative z-10">
              ...
              <p className="opacity-90 leading-relaxed mb-6">
                Enterprise-grade security with FERPA compliance, content
                filtering, and comprehensive audit logs to keep your classroom
                safe and compliant.
              </p>
