...
const AnalyticsCard = ({
  ...
  return (
    <div
      className={`bg-zinc-900 backdrop-blur-sm border border-gray-800/50 rounded-lg p-4 hover:bg-gray-800/30 transition-all duration-200 ${getVariantStyles()}`}
    >
...
const QuickActions = () => {
  ...
  return (
    <div className="bg-zinc-900 backdrop-blur-sm border border-gray-800/50 rounded-lg p-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-3">
        {actions.map((action) => (
          <button
            key={action.title}
            className={`flex flex-col items-center gap-2 p-4 rounded-lg border border-gray-800/50 transition-all duration-200 hover:border-gray-700 hover:scale-105 ${getColorClasses(
              action.color
            )}`}
          >
  ...
  const announcements = [
    {
      ...
      message:
        "The midterm examination schedule has been posted. Please review your assigned time slots and prepare accordingly.",
      author: "Dr. Sharma",
    ...
    },
    {
      ...
      message:
        "Tomorrow's lab session will be conducted in Room 301 instead of the usual location due to equipment maintenance.",
      author: "Dr. Sharma",
      timestamp: "1 day ago",
      priority: "normal",
      readBy: 32,
    ...
    },
    {
      ...
      message:
        "Due to upcoming deadlines, office hours will be extended until 6 PM on Wednesday and Thursday.",
      author: "Dr. Sharma",
    ...
    <div className="bg-zinc-900 backdrop-blur-sm border border-gray-800/50 rounded-lg p-6">
      ...
      <div className="space-y-4">
        {announcements.map((announcement) => (
          <div
            key={announcement.id}
            className="border border-gray-800/50 rounded-lg p-4 hover:border-gray-700/50 transition-colors"
          >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4 text-xs text-gray-500">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span>
                    {announcement.readBy}/{announcement.totalStudents}
                  </span>
                </div>
              </div>
...
const RecentActivity = () => {
  ...
  return (
    <div className="-mt-5 bg-zinc-900 backdrop-blur-sm border border-gray-800/50 rounded-lg h-fit">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                <div
                  className={`w-2 h-2 rounded-full ${getActivityIndicator(
                    activity.type
                  )}`}
                ></div>
...
const TeacherProfile = () => {
  return (
    <div className="bg-zinc-900 backdrop-blur-sm border border-gray-800/50 rounded-lg p-6 mb-6">
      ...
      <p className="text-sm text-gray-300 mb-4">
        ...
        Artificial Intelligence and Data Science. Dedicated to mentoring
        students and fostering research-driven learning.
      </p>
      <div className="flex flex-col gap-2 text-sm text-gray-400 mb-4">
        ...
        <div>
          <span className="font-medium text-gray-300">Office:</span> Room 215,
          Science Building
        </div>
        <div>
          <span className="font-medium text-gray-300">Research Interests:</span>{" "}
          AI, ML, NLP
        </div>
      </div>
